...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-btch/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-btch -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-btch -o bitcore-lib-btch.js';
    }
